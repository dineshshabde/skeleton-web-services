...
public class GreetingController {
	...
	// Inject an instance of GreetingService interface in GreetingController
	// Always use interface rather than implementation class...
	// Ensures programming by contract model and ensure only that the public
	// method is exposed by GreetinService interface are available to service
	// client
	@Autowired
